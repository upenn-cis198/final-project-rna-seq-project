...
// 	for (k, v) in counts.iter() {
// 		lw.write_fmt(format_args!("{}\t{}\n", 
// 			segment_id_strings.get((*k) as usize)
// 				.expect("Array index out of bounds with segment IDs"), v)).expect("Write failed");
// 	}
// 	return true;
// }
